...
export const BASE_URLS = {
  en: 'https://www.dynamitenews.com/wp-json/dynamite/v1/',
  hi: 'https://hindi.dynamitenews.com/wp-json/dynamite/v1/',
};
export const BaseUrl = 'https://hindi.dynamitenews.com/wp-json/dynamite/v1/';
export const BaseUrlEnglish =
  'https://www.dynamitenews.com/wp-json/dynamite/v1/';
...
export const Slider = 'latest-news';
