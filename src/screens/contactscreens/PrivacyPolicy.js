        ...
        <View style={ContactStyles.mainView}>
          <View style={ContactStyles.subView}>
            <Text style={ContactStyles.title}>
              DYNAMITE NEWS NETWORK PRIVATE LIMITED (“DNNPL”)
            </Text>

            <Text style={ContactStyles.content}>
              {' '}
              respects the privacy of its users and is committed to protect it
              in all respects. With a view to offer enriching internet
              experience to its users DNNPL offers a vast repository of channels
              and a variety of services. You may read ‘About Us’ to know more
              about DNNPL.
              {'\n'} The information about the user as collected by DNNPL is:
            </Text>

            <Text style={ContactStyles.title}>
              (A) Information supplied by users and Registration data:
            </Text>
            <Text style={ContactStyles.content}>
              When you register on the Site/Website, Application and for the
              Service, we ask that you provide basic contact Information such as
              your name, sex, age, address, pin code, contact number,
              occupation, interests and email address etc. When you register
              using your other accounts like on Facebook, Twitter, Gmail etc. we
              shall retrieve Information from such account to continue to
              ...
              expiration date etc. However, when you order using an in-app
              purchase option, same are handled by such platform providers. The
              subscriptions or paid Services may be on auto renewal mode unless
              cancelled. If at any point, you do not wish to auto-renew your
              subscription, you may cancel your subscription before the end of
              ...
              your content or email preferences, respond to a survey, or
              communicate with us.
            </Text>
            <Text style={ContactStyles.title}>
            ...
            <Text style={ContactStyles.content}>
              ...
              our Newsletter). A cookie cannot read data off your hard drive.
            ...
            <Text style={ContactStyles.content}>
              DNNPL may include links to other websites. Such sites are governed
              by their respective privacy policies, which are beyond our
              control. Once you leave our servers (you can tell where you are by
            ...
            <Text style={ContactStyles.content}>
              ...
              our websites or Applications — it is usually in the form of
              aggregated statistics on traffic to various pages / content within
              our websites or Applications. We use third-party advertising
              companies to serve ads when you visit our websites or
              Applications. These companies may use information (not including
              your name, address, email address or telephone number or other
              personally identifiable information) about your visits to this and
              other websites or application, in order to provide advertisements
            ...
            <Text style={ContactStyles.content}>
              ...
              some cases/provision of certain service(s) or uDNNPLity(ies), we
              ...
              (including advertising on the “Application”) and for developing
              ...
              twitter etc.
              {'\n'}Any posted/uploaded/conveyed/communicated by users on the
              public sections of the “Application” becomes published content and
              is not considered personally identifiable information subject to
              this Privacy Policy.
              {'\n'}In case you choose to decline to submit personally
              identifiable information on the Application, we may not be able to
              provide certain services on the Application to you. We will make
              ...
              {'\n'}When you register with the Application or Services, we
              contact you from time to time about updation of your personal
              information to provide the users such features that we believe may
            ...
            <Text style={ContactStyles.content}>
              When you use the Services Site (or any of its sub sites), we make
              good faith efforts to provide you, as and when requested by you,
              with access to your personal information and shall further ensure
            ...
            <Text style={ContactStyles.content}>
              ...
              store personal data. All information gathered on DNNPL is securely
              stored within the Company controlled database. The database is
              ...
              you visit or use our website, mobile application or services.
              These companies may use information (not including your name,
              address, email address or telephone number) about your visits or
              use to particular website, mobile application or services, in
            ...
            <Text style={ContactStyles.content}>
              ...
              {'\n'}If at any time, you believe that DNNPL or its users/members
              have not adhered to these principles, please notify us by e-mail
              at legal@dynamitenews.com and we will use all commercially
            ...
            <Text style={ContactStyles.content}>
              By using DNNPL’s sites and services, you signify your acceptance
              of this Privacy Policy. If you do not agree or are not comfortable
              with any policy described in this Privacy statement, your only
              remedy is to discontinue use of DNNPL sites. We reserve the right,
              to modify this Privacy Policy at any time.
            </Text>
          </View>
        </View>
      </ScrollView>
